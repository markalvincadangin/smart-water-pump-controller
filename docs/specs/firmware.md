...
- An **RC Snubber** MUST be installed across the A1 and A2 terminals of the magnetic contactor coil to absorb back-EMF and prevent 3.3V rail brownout resets. The system fails safe if a brownout does occur.
