...
1. **Repository Scope**: A single root constitution governs all software components within `smartflow`:
   ...
   - `dashboard/`: Next.js PWA user interface.
...
- **Supremacy**: This Constitution supersedes all informal team practices, feature requests, or unratified documentation across firmware, dashboard, and cloud functions.
